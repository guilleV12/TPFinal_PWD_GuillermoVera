    ...
    <ul class="navbar-nav">
      ...
      <div class="d-flex mx-5" >
        ...
        if ($objSession->validar()){ ?>
          ...
          <a href="javascript:void(0)" style="margin-right:10px !important;padding-top:5px" class="easyui-linkbutton" onclick="reloadCarrito(),$('#carrito').window('open')"><img style="height:20px;width:20px" src="../img/carrito.PNG"></a>
