...
?>
<h3 style="margin-left:1%">Mi cuenta</h3>
...
<div id="w" class="easyui-window" title="Usuario nuevo:" data-options="closed:true, iconCls:'icon-add'" style="width:610px;height:250px;padding:10px;">
        ...
        <form class="ff" method="post" name="ff" id="ff" style="margin-left:30%;" novalidate>
            ...
            <input id="usnombre" name="usnombre" type="hidden" class="easyui-textbox" data-options="required:true" >
...
<table id="dg" title="Mis datos" class="easyui-datagrid" style="width:500px;height:250px" url="listarClte.php" singleSelect="true">
        <thead>
        <tr>
...
<script type="text/javascript">
    ...
    function editUsuario(){
        ...
        if (row){
            ...
            $('#ff').form('load',row);
            url = 'editarClte.php?idusuario='+row.idusuario;
        }
    }
